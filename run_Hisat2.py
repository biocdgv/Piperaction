...
# 
#         
# Note: you should convert and sort this sam file into a coordinated bam file, in order to do some other tasks such as genome guided assembly with Trinity (Grabherr et al. 2011). This conversion can be done by samtools (Li et al. 2009), like shown in run_samtools.py.
# 
# 
# 
# Highlights:
